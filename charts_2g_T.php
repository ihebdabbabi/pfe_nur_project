...
while ($row = mysqli_fetch_array($result)) {
    ...
    // Check if filterValue is set and apply the filter
    if ($hasFilter && $di2Gh > $filterValue) {
        ?>
        <tr>
            <td><?php echo $date ?></td>
...
copyBtn.addEventListener('click', function () {
  ...
  window.open('mailto:iheb.dabbabii@gmail.com?cc=iheb.dabbabii@gmail.com&subject=Bilan 2G&body=','_self');
