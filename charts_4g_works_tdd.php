...
<html>
<head>
<title>charts-4G-works_TDD</title>
<style> 
...
$query2 = "SELECT Cell_Name ,Indispo_sys_F_group_DI_h ,SUBSTR(Cell_Name, 1, 8) as Site FROM `4g_prs` WHERE Cell_FDD_TDD_Indication='CELL_TDD'";
